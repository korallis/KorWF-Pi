...
| 12 | Reuse | `questionnaire.ts` | 1–82 (types, schema, `errorResult`) and 110–394 (`ctx.ui.custom` component) | `extension/ui/questionnaire.ts` | MIT |
